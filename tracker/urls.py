...
urlpatterns = [
    ...
    path('dueVax/', views.dueVax, name='dueVax'),
    path('dueVaxEmail/<str:pk>', views.dueVaxEmail, name='dueVaxEmail'),
    path('unconfirmedAppts/', views.unconfirmedAppts, name='unconfirmedAppts'),
    path('unconfirmedApptsEmail/<str:pk>', views.unconfirmedApptsEmail, name='unconfirmedApptsEmail'),
